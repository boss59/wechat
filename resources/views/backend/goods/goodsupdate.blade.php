...
@section('content')
<form class="layui-form" action="/goods/edit" method="post" style="margin: 50px ;" id="form" enctype="multipart/form-data">
<input type="hidden" name="goods_id" value="{{ $goodsInfo->goods_id }}">
@csrf
<div class="layui-form-item">
    <label class="layui-form-label">商品名</label>
    <div class="layui-input-block">
      <input type="text" name="goods_name" value="{{ $goodsInfo->goods_name}}" required  lay-verify="required" placeholder="请输入商品名" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">商品金额</label>
    <div class="layui-input-block">
      <input type="text" name="goods_price" value="{{ $goodsInfo->goods_price}}" required  lay-verify="required" placeholder="请输入商品金额" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">商品数量</label>
    <div class="layui-input-block">
      <input type="text" name="goods_num" value="{{ $goodsInfo->goods_num}}" required  lay-verify="required" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div>
      ...
      <input type="radio" name="is_sell" value="2" checked>否
      @endif
    </div>
  </div>
  <div class="layui-form-item">
