      ...
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"><img src="{{ $goods->goods_img }}" width="300" height="300"/></div>
            @foreach($goods->goods_imgs as $k=>$v)
            <div class="swiper-slide">
              <img src="{{$v}}" width="300" height="300" />
            </div>
            @endforeach
        ...
        <div class="wy-media-box-nomg weui-media-box_text">
          <h4 class="wy-media-box__title">{{ $goods->goods_name }}</h4>
          <div class="wy-pro-pri mg-tb-5">¥<em class="num font-20" id="price">{{ $goods->goods_price }} </em></div>
          <p class="weui-media-box__desc">{{ $goods->goods_desc }}</p>
        </div>
...
<div class="weui-tabbar wy-foot-menu">
  ...
  <a href="javascript:;" id='show-toast' class="promotion-foot-menu-items" goods_id="{{ $goods->goods_id }}">
    <div class="weui-tabbar__icon promotion-foot-menu-collection"></div>
    <p class="weui-tabbar__label">收藏</p>
  </a>
  <a href="/weui/cart" class="promotion-foot-menu-items">
    <span class="weui-badge" style="position: absolute;top: -.4em;right: 1em;">8</span>
    <div class="weui-tabbar__icon promotion-foot-menu-cart"></div>
    <p class="weui-tabbar__label">购物车</p>
  </a>
  <a id="addCar" class="weui-tabbar__item yellow-color open-popup" goods_id="{{ $goods->goods_id }}" data-target="#join_cart">
...
<div id="join_cart" class='weui-popup__container popup-bottom' style="z-index:600;">
  <div class="weui-popup__overlay" style="opacity:1;" id="cart"></div>
      ...
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="/weui/cart" class="weui-btn weui-btn_primary">去购物车结算</a>
  ...
  <div class="weui-popup__modal">
    ...
    <div class="modal-content">
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="/weui/orderinfo" class="weui-btn weui-btn_primary">立即购买</a>
            <a href="javascript:;" class="weui-btn weui-btn_default close-popup">不，我再看看</a>
          </p>
        </div>
      </div>
...
$(function(){
  $(document).on('click','#addCar',function(){
    ...
    var add_price = $('#price').text();
    var buy_number = 1;
    // var url = 
    $.ajax({
      url:'/weui/addCary',//请求地址
      type:'POST',//请求的类型
      dataType:'json',//返回的类型
      data:{goods_id:goods_id,buy_number:buy_number,add_price:add_price},//要传输的数据
      success:function(res){ //成功之后回调的方法
          var url = "/weui/proinfo?goods_id="+goods_id;
          if (res.code==3) {
            if (confirm(res.font)) {
              location.href = "/weui/Login?refer="+url;
            }
          }
          if (res.code==1) {
          }
